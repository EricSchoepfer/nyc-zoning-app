...
document.getElementById("addressBtn").onclick = async function() {
    ...
    // PUBLIC SQL ROUTE: Bypasses browser cross-origin locks natively without third-party proxies
...
async function executeQueryPipeline(queryUrl, fallbackLabel, buttonId, originalButtonText) {
    ...
    try {
        ...
        // MUNICIPAL GEOSPATIAL PARSER: Extracts target values from structured rows objects natively
